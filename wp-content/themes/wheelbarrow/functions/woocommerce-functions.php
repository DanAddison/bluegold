...
add_action('woocommerce_before_main_content', 'wheelbarrow_open_div', 5);
 
function wheelbarrow_open_div() {
    echo '<div class="row row--pad row--woo">';
}
 
// Closing div for our content wrapper
add_action('woocommerce_after_main_content', 'wheelbarrow_close_div', 50);
 
function wheelbarrow_close_div() {
    echo '</div>';
}

/**
 * remove page title from all woo archives
 */
add_filter( 'woocommerce_show_page_title', '__return_null' );

/**
 * remove sorting dropdown from Woo archives
 */
...
/**
 * add list of product categories on shop archives
 */
// function signal_archive_categories_list() {
// 	$args = array(
// 		'separator' => ' &sol;&sol; ',
// 		'style' => 'list',
...
// 	echo '</ul></div>';
// }
// add_action( 'woocommerce_after_shop_loop', 'signal_archive_categories_list', 7 );
